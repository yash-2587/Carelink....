...
include('func.php');  
include('newfunc.php');
$con=mysqli_connect("localhost","root","2629","myhmsdb");
...
if(isset($_GET["generate_bill"])){
  ...
  $content .= '
      <br/>
      <h2 align ="center"> CareLinks</h2></br>
...
<html lang="en">
  ...
  <a class="navbar-brand" href="#"><i class="fa fa-user-plus" aria-hidden="true"></i> CareLink </a>
  ...
  <style >
    .bg-primary {
    background: -webkit-linear-gradient(left, #0f0c39, #00c6ff);
}
